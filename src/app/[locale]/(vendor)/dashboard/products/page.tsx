    ...
    return (
        <div className="space-y-10">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-[#8FA998] mb-2">Gestion Inventaire</h2>
                    <h1 className="text-4xl font-serif font-black tracking-tight text-zinc-950 italic">Mes Produits</h1>
                    <p className="text-zinc-500 mt-2 font-medium">Gérez votre catalogue et vos stocks avec élégance.</p>
                </div>
                <Link
            ...
            {products.length === 0 ? (
                <div className="bg-[#FAF9F6] rounded-[3rem] border border-zinc-100 p-20 text-center space-y-8">
                    ...
                    <div className="space-y-3 max-w-sm mx-auto">
                        <h3 className="text-2xl font-serif font-black italic text-zinc-950">Votre catalogue est vide</h3>
                        <p className="text-zinc-500 font-medium">L'élégance commence par votre premier produit.</p>
                    </div>
                    <Link
                        href="/dashboard/products/new"
