...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (explicit test step requires using navigate to exact path)
        await page.goto("http://localhost:3000/login", wait_until="commit", timeout=10000)
        
        # -> Type the vendor email into the email field (index 328) as the next immediate action.
