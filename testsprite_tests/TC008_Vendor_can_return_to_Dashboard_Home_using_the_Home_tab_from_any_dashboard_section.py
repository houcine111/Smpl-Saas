...
async def run_test():
    ...
    try:
        ...
        # -> Type the vendor email into the email input (index 514) and then type the password (index 515), then click the Sign In (submit) button (index 518).
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Paramètres' (Settings) navigation link (index 837) to navigate to the settings page.
        frame = context.pages[-1]
        # Click element
